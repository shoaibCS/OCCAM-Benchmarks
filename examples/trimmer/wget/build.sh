...
"modules": ["libc.a.bc","libpcre.a.bc","libz.a.bc"], 
"ldflags": ["-luuid","-lgnutls", "-lnettle", "-lidn", "-lpthread","-O3"], 
"main": "wget.bc"}
EOF
...
then
    ...
    strip slash/wget_fin -o slash/wget_fin_stripped
    cp slash/wget_fin_stripped .
else
