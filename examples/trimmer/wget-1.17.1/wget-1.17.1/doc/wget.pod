...
even if B<--progress=bar> was passed to Wget during invokation. This
...
Specifying B<SSLv2>, B<SSLv3>, B<TLSv1>, B<TLSv1_1> or
B<TLSv1_2> forces the use of the corresponding protocol.  This is
